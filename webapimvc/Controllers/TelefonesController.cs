...
namespace webapimvc.Controllers
{
    public class TelefonesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("id,ddd,numero,referencia")] Telefone telefone)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("id,ddd,numero,referencia")] Telefone telefone)
        {
            if (id != telefone.id)
            {
                return NotFound();
